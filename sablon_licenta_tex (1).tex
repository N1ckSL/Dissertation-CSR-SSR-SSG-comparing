...
Din acest punct de vedere, aplica\c tia construita cu vanilla JS este mai performant\u a, \^ in compara\c tie cu restul, care sunt construite cu ajutorul unor framework-uri, care necesit\u a un set de biblioteci suplimentare pentru a func\c tiona.
...
\begin{itemize}
	...
	\item Next.js \(\sim \) 412.2 KB
	\item Gatsby \(\sim \) 124.7 KB (\textit{cu optimizarea imaginilor}) \c si 205.3 KB (\textit{f\u ar\u a optimizarea imaginilor}) 
\end{itemize}

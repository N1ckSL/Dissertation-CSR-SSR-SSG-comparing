...
% 	\begin{tabular}{lllll}
% 		\toprule
% 		\textbf{01-JavaScript} & \textbf{LCP} & \textbf{CLS} & \textbf{FID} & \textbf{INP} \\
% 		\midrule
% 		Fast Internet & 0.241s & 0.006 & 0.500ms & 32.000ms \\
% 		Slow 3G & 7.286s & 0.006 & 0.800ms & 16.000ms \\
% 		\bottomrule
% 	\end{tabular}
% 	\caption{Rezultatele pentru aplica\c tia vanilla JavaScript}
% 	\label{tab:web-vitals-js}
% \end{table}
...
% 	\begin{tabular}{lllll}
% 		\toprule
% 		\textbf{02-React} & \textbf{LCP} & \textbf{CLS} & \textbf{FID} & \textbf{INP} \\
% 		\midrule
% 		Fast Internet & 0.787s & 0.002 & 0.900ms & 32.000ms \\
% 		Slow 3G & 8.394s & 0.002 & 1.000ms & 16.000ms \\
% 		\bottomrule
% 	\end{tabular}
% 	\caption{Rezultatele pentru aplica\c tia React}
% 	\label{tab:web-vitals-react}
% \end{table}
...
% 	\begin{tabular}{lllll}
% 		\toprule
% 		\textbf{03-Next} & \textbf{LCP} & \textbf{CLS} & \textbf{FID} & \textbf{INP} \\
% 		\midrule
% 		Fast Internet & 0.448s & 0.002 & 1.100ms & 32.000ms \\
% 		Slow 3G & 10.849s & 0.002 & 1.300ms & 40.000ms \\
% 		\bottomrule
% 	\end{tabular}
% 	\caption{Results for the Next.js application}
% 	\label{tab:web-vitals-next}
% \end{table}
...
% 	\begin{tabular}{lllll}
% 		\toprule
% 		\textbf{04-Gatsby} & \textbf{LCP} & \textbf{CLS} & \textbf{FID} & \textbf{INP} \\
% 		\midrule
% 		Fast Internet & 0.084s & 0.002 & 0.900ms & 16.000ms \\
% 		Slow 3G & 2.127s & 0.002 & 0.900ms & 40.000ms \\
% 		\bottomrule
% 	\end{tabular}
% 	\caption{Results for the Gatsby application}
% 	\label{tab:web-vitals-gatsby}
% \end{table}
